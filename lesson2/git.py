...
залить на гитхаб
    git push 
    git push <remote-name> <branch-name> - с уточнением удаленного репозитория и названия ветки
    
    для новых веток делаем 1 раз
    git push --set-upstream origin <branch_name> - скопировать в хаб и назначить удаленную ветку
    git push -u origin <branch_name> - назначить удаленную ветку - тоже самое
...
токены
    ...
    токен - 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
    https://github.com/belhard53/belhard_test_87_1.git

    git clone https://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@github.com/belhard53/belhard_test_87_1.git
